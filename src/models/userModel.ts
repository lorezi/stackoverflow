...
import mongoose, {Types, Document, Schema, Model, model, Query} from 'mongoose';
...
export interface IUser extends IUserDocument{
  correctPassword(candidatePassword: string, userPassword:string|undefined): boolean
} 
...
userSchema.method('correctPassword',async function (candidatePassword, userPassword): Promise<boolean> {
